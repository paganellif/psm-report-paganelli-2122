...
\usepackage{hyperref}
%------------------------------------------------------------
\titlegraphic{\includegraphics[height=1.5cm]{maggioli.png}} 
...
\title[Alma Mater Studiorum - Università di Bologna]{MaggioliEbook \\ Digital Publishing E-Reader Mobile App}%主标题
%\subtitle{ }%%副标题
\author[Filippo Paganelli]{Filippo Paganelli \\ }%%作者
